...
class _RequestsState extends State<Requests> {
  ...
  Future<void> _replyToReport(var id) async {
    if (_replyController.text.isEmpty) {
      ...
      try {
        final response =
            await _accidentService.replyToWorkshopRequest(replydata);
        print(response.data);
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
  ...
  Future<void> getReportsByUserid() async {
    ...
    var userMap = jsonDecode(user!);
    print(userMap);
    var userdata = jsonEncode({"workshopid": userMap['_id']});
    try {
      final response = await _accidentService.getRequestByWorkshopId(userdata);
      print(response.data);
