...
import 'package:firstcall/services/utilservice.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  getProfile() async {
    ...
    try {
      final Response res = await _utilityService.getUser(userMap['_id']!);
      if (mounted) {
        setState(() {
          _data = res.data;
  ...
  updateEmail() async {
    ...
    try {
      final Response res =
          await _utilityService.updateEmail(_email.text, userMap['_id']!);
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
  ...
  updatePhone() async {
    ...
    try {
      final Response res = await _utilityService.updatePhoneNumber(
          int.parse(_phone.text.toString()), userMap['_id']!);
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
  ...
  changePassword() async {
    ...
    var userMap = jsonDecode(user!);
    try {
      final Response res = await _utilityService.updatePassword(
          _newpassword.text, userMap['_id']!);
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
